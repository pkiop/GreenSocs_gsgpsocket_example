...
int sc_main(int argc, char* argv[])
{
  ...
  //macro check
  #ifdef USE_GPSOCKET
  cout << "USE_GPSOCKET" << endl;
  #else
  cout << "NOT_USE_GESOCKET" << endl;
  #endif
  #ifdef USE_BLOCKING_API
  cout << "USE_BLOCKING_API" << endl;
  #else
  cout << "NOT_USE_BLOCKING_API" << endl;
  #endif
  #ifdef WRITE_RESPONSE_NEEDED
  cout << "WRITE_RESPONSE_NEEDED" << endl;
  #else
  cout << "NOT WRITE_RESPONSE_NEEDED" << endl;
  #endif
  #ifdef USE_PV
  cout << "USE_PV" << endl;
  #else
  cout << "NOT_USE_PV" << endl;
  #endif
  #ifdef USE_CC
  cout << "USE_CC" << endl;
  #else
  cout << "NOT_USE_CC" << endl;
  #endif
  #ifdef WRITE_RESPONSE_NEEDED
  cout << "WRITE_RESPONSE_NEEDED" << endl;
  #else
  cout << "NOT_WRITE_RESPONSE_NEEDED" << endl;
  #endif
  #ifdef WRITE_RESPONSE_SEND
  cout << "WRITE_RESPONSE_SEND" << endl;
  #else
  cout << "NOT_WRITE_RESPONSE_SEND" << endl;
  #endif
  #ifdef USE_SETSDATA_TO_WRITE_DATA
  cout << "USE_SETSDATA_TO_WRITE_DATA" << endl;
  #else
  cout << "NOT_USE_SETSDATA_TO_WRITE_DATA" << endl;
  #endif
